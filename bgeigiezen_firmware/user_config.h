...
constexpr uint32_t STATUS_MESSAGE_DURATION = 2000;  // 2s
...
#define D_SCREEN_DIM_TIMEOUT 15     // 15 seconds until screen dims
#define D_SCREEN_OFF_TIMEOUT 600   // 600 seconds (10 minutes) until screen turns off
